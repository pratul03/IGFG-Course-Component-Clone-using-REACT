...
import { arrayInPython } from "../../public/arraydata/arrayInPython";
...
const ArrayInPythonLang = () => {
  ...
  const handleCodeChange = (key, value) => {
    arrayInPython[0].topics[0].content = arrayInPython[0].topics[0].content.map(
      (item, idx) =>
...
export default ArrayInPythonLang;
