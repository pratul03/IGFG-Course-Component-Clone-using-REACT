...
import { arrayInJavaScript } from "../../public/arraydata/arrayInJs";
...
const ArrayInjavaScriptLang = () => {
  ...
  const handleCodeChange = (key, value) => {
    arrayInJavaScript[0].topics[0].content =
      arrayInJavaScript[0].topics[0].content.map((item, idx) =>
  ...
  return (
    <div className="flex w-full flex-col p-6 text-[#0e0e0e]">
      <div className="left-0 ml-[-10px] flex flex-col w-full max-w-5xl mx-auto text-[#0e0e0e] shadow-lg">
        {arrayInJavaScript[0]?.topics?.map((topic, topicIndex) => (
                    ...
                    >
                      {item.items.map((listItem, listIndex) => (
                        <li key={listIndex} className="mb-2">
                          ...
                          {listItem.image?.url && (
                            <div className="flex flex-col justify-center content-center items-center bg-slate-300">
                              <img
...
export default ArrayInjavaScriptLang;
